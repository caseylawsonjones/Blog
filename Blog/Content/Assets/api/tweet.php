<?php
    require_once("~Content/Assets/api/twitteroauth/twitteroauth.php"); // Path to twitteroauth library
    require_once('~Content/Assets/api/config.php'); // Path to config file
